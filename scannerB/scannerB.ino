/*
 * ═══════════════════════════════════════════════════════
 *  SCANNER B - OPTIMISÉ AVEC LOOKUP TABLE
...
#define SCANNER_ID "B"
float SCANNER_X = 0.25;  // 28.5 cm du bord gauche
float SCANNER_Y = 0.25;   // 25 cm du bas
...
// ThingsBoard
const String THINGSBOARD_TOKEN = "8bNTPkEWwtHrPOH5ATJL";
...
// ════════════════════════════════════════════════════════
// FONCTION : FILTRAGE RSSI - MÉDIANE
// ════════════════════════════════════════════════════════
...
void setup() {
  ...
  Serial.println("\n\n╔═══════════════════════════════════════╗");
  Serial.println("║   SCANNER B - LOOKUP TABLE OPTIMISÉ  ║");
  Serial.println("║   Position : (28.5, 25.0) cm         ║");
  Serial.println("╚═══════════════════════════════════════╝\n");
...
void loop() {
  ...
  Serial.println("┌── SCAN #" + String(scanCount) + " ─ Scanner B (28.5,25)cm ──┐");
  
  // Scan BLE pendant 2 secondes
